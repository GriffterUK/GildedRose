...
namespace GildedRose.Tests
{
    public class GildedRoseShould
    {
        ...
        {  
            ...
            //iterativeInventories[1].AddItem(ItemBuilder.AnItem().WithName("Conjured Mana Cake").WithSellIn(2).WithQuality(5).Build());
            ...
            //iterativeInventories[2].AddItem(ItemBuilder.AnItem().WithName("Conjured Mana Cake").WithSellIn(1).WithQuality(4).Build());
            ...
            //iterativeInventories[3].AddItem(ItemBuilder.AnItem().WithName("Conjured Mana Cake").WithSellIn(0).WithQuality(3).Build());
            ...
            //iterativeInventories[4].AddItem(ItemBuilder.AnItem().WithName("Conjured Mana Cake").WithSellIn(-1).WithQuality(1).Build());
